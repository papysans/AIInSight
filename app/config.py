...
class Config:
    ...
    # --- Source Groups & Evidence Settings ---
    SOURCE_GROUPS = {
    ...
    DEFAULT_SOURCE_GROUPS = ["media", "research", "code", "community"]

    @classmethod
    def get_available_sources(cls):
        return sorted({name for names in cls.SOURCE_GROUPS.values() for name in names})
    ...
    REDDIT_USER_AGENT = os.getenv("REDDIT_USER_AGENT", "AIInSight/1.0")
